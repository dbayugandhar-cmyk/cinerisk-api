...
<div class="footer"><span>CINEOS · Banking Fraud Intelligence · Patent 64/049,190 · yugandhar@cineos.in</span><span>RESTRICTED · {cid}</span></div>
</body></html>'''
...
<body><div class="header"><div class="logo">CINEOS</div><h1>Banking Fraud Intelligence — Case Studies</h1><div class="sub">UPI Mule · KYC Fraud · Loan Fraud · Investment Fraud · Hawala · Patent 64/049,190 · {datetime.now(IST).strftime("%Y-%m-%d")}</div></div>
