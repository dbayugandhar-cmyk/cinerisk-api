# Run this on your Mac: python3 create_api.py
# It writes api.py directly to ~/Desktop/cinerisk/
import os
...
path = os.path.expanduser("~/Desktop/cinerisk/api.py")
os.makedirs(os.path.dirname(path), exist_ok=True)
with open(path, "w") as f:
    f.write(api_code.strip())
print(f"Created: {path}")
print("Now run: python3 -m uvicorn api:app --reload --port 8000")
